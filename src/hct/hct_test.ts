...
describe("CAM to ARGB", () => {
  it("red", () => {
    ...
    expect(cam.s).toBeCloseTo(91.89, 3);
  ...
  it("green", () => {
    ...
    expect(cam.hue).toBeCloseTo(142.14, 3);
    expect(cam.chroma).toBeCloseTo(108.41, 3);
    expect(cam.j).toBeCloseTo(79.332, 3);
    expect(cam.m).toBeCloseTo(85.588, 3);
    expect(cam.s).toBeCloseTo(78.605, 3);
    expect(cam.q).toBeCloseTo(138.52, 3);
  });
...
describe("ARGB to HCT", () => {
  it("green", () => {
    ...
    expect(hct.chroma).toBeCloseTo(108.41, 2);
  ...
  it("blue", () => {
    ...
    expect(hct.chroma).toBeCloseTo(87.23, 2);
    expect(hct.tone).toBeCloseTo(32.302, 2);
  });

  it("blue tone 90", () => {
    const hct = Hct.from(282.788, 87.23, 90.0);
