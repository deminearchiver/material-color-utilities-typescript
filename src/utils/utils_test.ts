...
describe("lstarFromY", () => {
  it("satisfies given values", () => {
    ...
    expect(colorUtils.lstarFromY(3.0)).toBeCloseTo(20.043897, 5);
    ...
    expect(colorUtils.lstarFromY(15.0)).toBeCloseTo(45.634197, 5);
    ...
    expect(colorUtils.lstarFromY(50.0)).toBeCloseTo(76.069261, 5);
